...
| Run a 100 um cube playbook / add a cube dataset | `connectomics/playbooks/README.md`; sequence in `playbooks/cube_decode.py`, engine in `runtime/volume_pipeline.py`, masks in `data/keep_mask.py` | `python scripts/run_playbook.py --params tutorials/neuron_<name>/params.yaml` |
